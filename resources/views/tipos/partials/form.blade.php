<div class="form-group{{ $errors->has('nombre') ? ' has-error' : '' }}">
    ...
    {{ Form::text('nombre',null,['class'=> 'form-control text-uppercase', 'placeholder'=>'NOMBRE DEL CARGO A ELECCION']) }}
...
<div class="form-group">
    ...
    {{ Form::textarea('descripcion',null,['class'=> 'form-control text-uppercase', 'rows'=>'3', 'placeholder'=>'BREVE DESCRIPCION DEL CARGO A ELECCION']) }}
</div>
